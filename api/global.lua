...
-----------------------
-- @field[parent = #global] UIGroup#UIGroup UIGroup preloaded module
...
-----------------------
-- @field[parent = #global] of#of of preloaded module
...
-----------------------
-- @field[parent = #global] UIImage#UIImage UIImage preloaded module
...
-----------------------
-- @field[parent = #global] Component#Component Component preloaded module
...
-----------------------
-- @field[parent = #global] UISlider#UISlider UISlider preloaded module
...
-----------------------
-- @field[parent = #global] EventProxy#EventProxy EventProxy preloaded module
...
-----------------------
-- @field[parent = #global] UILayout#UILayout UILayout preloaded module
...
-----------------------
-- @field[parent = #global] BasicLayoutProtocol#BasicLayoutProtocol BasicLayoutProtocol preloaded module
...
-----------------------
-- @field[parent = #global] GameObject#GameObject GameObject preloaded module
...
-----------------------
-- @field[parent = #global] Registry#Registry Registry preloaded module
...
-----------------------
-- @field[parent = #global] which#which which preloaded module

-----------------------
-- @field[parent = #global] init#init init preloaded module

-----------------------
-- @field[parent = #global] if#if if preloaded module

-----------------------
-- @field[parent = #global] CCArmatureAnimation#CCArmatureAnimation CCArmatureAnimation preloaded module

-----------------------
-- @field[parent = #global] UICheckBoxButton#UICheckBoxButton UICheckBoxButton preloaded module
...
-----------------------
-- @field[parent = #global] UIButton#UIButton UIButton preloaded module
...
-----------------------
-- @field[parent = #global] is#is is preloaded module
...
-----------------------
-- @field[parent = #global] like#like like preloaded module
...
-----------------------
-- @field[parent = #global] cocos2dx#cocos2dx cocos2dx preloaded module
...
-----------------------
-- @field[parent = #global] UIPushButton#UIPushButton UIPushButton preloaded module
...
-----------------------
-- @field[parent = #global] Event#Event Event preloaded module
...
-----------------------
-- @field[parent = #global] UIStretch#UIStretch UIStretch preloaded module
...
-----------------------
-- @field[parent = #global] UICheckBoxButtonGroup#UICheckBoxButtonGroup UICheckBoxButtonGroup preloaded module

-----------------------
-- @field[parent = #global] CCMovementData#CCMovementData CCMovementData preloaded module

-----------------------
-- @field[parent = #global] that#that that preloaded module

-----------------------
-- @field[parent = #global] allows#allows allows preloaded module
...
-----------------------
-- @field[parent = #global] UILabel#UILabel UILabel preloaded module
...
-----------------------
-- @field[parent = #global] LayoutProtocol#LayoutProtocol LayoutProtocol preloaded module
...
-----------------------
-- @field[parent = #global] actions#actions actions preloaded module
...
-----------------------
-- @field[parent = #global] to#to to preloaded module

-----------------------
-- @field[parent = #global] from#from from preloaded module
...
-----------------------
-- @field[parent = #global] StateMachine#StateMachine StateMachine preloaded module

-----------------------
-- @field[parent = #global] CCMenuItemImage#CCMenuItemImage CCMenuItemImage preloaded module

-----------------------
-- @field[parent = #global] for#for for preloaded module
...
-----------------------
-- @field[parent = #global] UIBoxLayout#UIBoxLayout UIBoxLayout preloaded module
...
-----------------------
-- @field[parent = #global] CCEventDispatcher#CCEventDispatcher CCEventDispatcher preloaded module
